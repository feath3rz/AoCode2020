...
#both must have the same subject number
#but the card and the door have a different loop size

card_public = 12232269
door_public = 19452773
...
while remainder != card_public:
  value = value * card_subject
  remainder = value % 20201227
  value = remainder
  card_loop = card_loop + 1

print("Card:", card_subject, card_loop)

door_subject = 7
remainder = 0
door_loop = 0
value = 1
while remainder != door_public:
  value = value * door_subject
  remainder = value % 20201227
  value = remainder
  door_loop = door_loop + 1

print("Door:", door_subject, door_loop)

card_subject = door_public
door_subject = card_public
value = 1
