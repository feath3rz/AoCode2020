...
while (len(player1) != 0) and (len(player2) != 0):
  if player1[0] > player2[0]:
    player1.append(copy.deepcopy(player1[0]))
    player1.append(copy.deepcopy(player2[0]))
  else:
    player2.append(copy.deepcopy(player2[0]))
    player2.append(copy.deepcopy(player1[0]))
  player1.pop(0)
  player2.pop(0)
...
if len(player1) != 0:
  while j < len(player1):
    count = count + (player1[j] * (len(player1) - j))
    j = j + 1
else:
  while j < len(player2):
    count = count + (player2[j] * (len(player2) - j))
    j = j + 1
