...
# -----------------------------------------------------------------------------------
# NOTE: I didn't code this one but I entered it into an excel sheet. Unfortunately
# I can't find it at the moment. All I have is the screen shot of the Part 2
# that I solved. But I was able to logic the puzzle.  And Part 2 is not solvable
# unless you solve Part 1.  Sorry.
# -----------------------------------------------------------------------------------
